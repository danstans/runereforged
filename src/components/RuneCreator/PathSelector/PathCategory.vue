...
export default {
  ...
  methods: {
    ...
    selectPath: function(pathId, keystones, runetiers) {
      ...
      this.updatePossibleSecondaryPaths({
        primaryIndex: this.categoryIndex,
        paths: this.getPaths
      });
...
.ring {
  background: url("https://d181w3hxxigzvh.cloudfront.net/wp-content/themes/rune_forge/imgs/rune-paths/ring.png");
}
</style>
